...
def api_debug():
    return jsonify({
        ...
        'places_key_set': bool(os.getenv('GOOGLE_PLACES_API_KEY')),
        'gemini_key_prefix': os.getenv('GEMINI_API_KEY', '')[:8] + '...' if os.getenv('GEMINI_API_KEY') else 'NOT SET',
        'places_key_prefix': os.getenv('GOOGLE_PLACES_API_KEY', '')[:8] + '...' if os.getenv('GOOGLE_PLACES_API_KEY') else 'NOT SET',
    })
